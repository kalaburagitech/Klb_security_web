...
export function AttendanceWeekView({ navigation, refreshToken = 0 }: Props) {
    ...
    const dayRecords = useMemo(
        () => weekRecords.filter((r) => r.date === selectedDate),
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    navigation.navigate('MarkAttendance', {
                                        ...
                                        directCamera: true,
                                        checkoutSiteStub:
                                            r.siteId && customUser?.regionId
                                                ? {
                                                      _id: r.siteId,
                                                      name: r.siteName || 'Site',
                                                      regionId: customUser.regionId,
                                                      city: (customUser as { city?: string }).city,
                                                      shifts: [],
                                                  }
                                                : undefined,
                                        checkoutShiftName: r.shiftName,
                                    })
                                }
                            >
