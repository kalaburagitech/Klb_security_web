                                    ...
                                    <View style={styles.detailsRow}>
                                        ...
                                        {item.empCode && (
                                            <>
                                                ...
                                                <Text style={styles.empCode}>Code: {item.empCode}</Text>
                                            </>
                                        )}
                                    </View>
                                ...
                                <View style={styles.detailsSection}>
                                    ...
                                    {item.checkInTime && item.checkOutTime && (
                                        <View style={styles.detailItem}>
                                            ...
                                            <Text style={styles.detailValue}>
                                                {Math.round((item.checkOutTime - item.checkInTime) / (1000 * 60 * 60))} hours
                                            </Text>
                                        </View>
                                    )}
                                    ...
                                    {item.locationAccuracy && (
                                        <View style={styles.detailItem}>
                                            ...
                                            <Text style={styles.detailValue}>{Math.round(item.locationAccuracy)}m</Text>
                                        </View>
                                    )}
                                </View>
                            )}
