...
import { Loader2, Eye, X, Image as ImageIcon } from "lucide-react";
...
export default function PatrolLogs() {
    ...
    const patrolLogs = useQuery(
        isOwner ? api.logs.listAllPatrolLogs : api.logs.listPatrolLogs,
                    ...
                    >
                        <div className="p-4 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                            <div className="flex items-center gap-2 text-white/90">
                                ...
                                <span className="text-sm font-semibold">Patrol Upload View</span>
                            </div>
                            <button 
                                onClick={() => setSelectedImage(null)}
